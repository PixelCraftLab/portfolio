...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: "/assets/Gallery/Cam2.png", text: 'Video Shoot' },
      { image: "/assets/Gallery/ImaginCupTeam.png", text: 'Microsoft ImaginCup Team' },
      { image: "/assets/Gallery/Cam.png", text: 'Shoot Prep' },
